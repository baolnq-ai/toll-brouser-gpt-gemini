...
install_browser_use() {
	...
	run_step "Installing browser-use package" uv pip install "$tmp_dir" --no-deps
	...
	run_step "Installing minimal CLI dependencies" uv pip install -r "$tmp_dir/browser_use/skill_cli/requirements-cli.txt"
